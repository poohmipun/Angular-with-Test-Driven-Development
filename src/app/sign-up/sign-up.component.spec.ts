...
describe('SignUpComponent', () => {
  ...
  describe('Interactions', () => {
    ...
    const setupForm = async () => {
      ...
      fixture.detectChanges(); /* trigger ui updated */
    ...
    it('displays spinner while the API request is in progress', async () => {
      ...
      fixture.detectChanges();
      const signUp = fixture.nativeElement as HTMLElement;
      const spinnerElement = signUp.querySelector('span[role="status"]');
    ...
    it('hides sign up from after successful sign up request', async () => {
      ...
      // Replace `button` with the appropriate button element in your test setup
